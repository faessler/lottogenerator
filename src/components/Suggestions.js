        ...
        return (
            <section className="suggestions">
                <div className="suggestions__numbers">
                    <b>{lottery.numbers.quantity} Number{lottery.numbers.quantity > 1 && 's'} ({lottery.numbers.min} - {lottery.numbers.max})</b>
                    <b>{lottery.additional.quantity} {this.additionalLegend()} ({lottery.additional.min} - {lottery.additional.max})</b>
                    {
                        lottery.suggestions.map((suggestion, index) =>
                            <React.Fragment key={index}>
                                <Numbers numbers={suggestion.numbers} />
                                <Numbers numbers={suggestion.additional} type={lottery.additional.type} />
                                <button onClick={() => {this.props.onClickDeleteSuggestion(lotteryKey, index)}}><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 64 64" xmlSpace="preserve"><path d="M7.8,18.8l3.3,40.1c0.2,2.9,2.7,5.2,5.6,5.2h30.6c2.9,0,5.4-2.3,5.6-5.2l3.3-40.1H7.8z M22.6,56.5c-1,0-1.8-0.8-1.9-1.8l-1.9-30.2c-0.1-1,0.7-1.9,1.8-2c1.1-0.1,1.9,0.7,2,1.8l1.9,30.2C24.6,55.6,23.7,56.5,22.6,56.5z M33.9,54.6c0,1-0.8,1.9-1.9,1.9c-1,0-1.9-0.8-1.9-1.9V24.4c0-1,0.8-1.9,1.9-1.9c1,0,1.9,0.8,1.9,1.9V54.6z M45.1,24.5l-1.9,30.2c-0.1,1-0.9,1.8-2,1.8c-1-0.1-1.8-1-1.8-2l1.9-30.2c0.1-1,1-1.8,2-1.8C44.4,22.6,45.2,23.5,45.1,24.5z"/><path d="M56.4,7.5H45.1V5.6c0-3.1-2.5-5.6-5.6-5.6h-15c-3.1,0-5.6,2.5-5.6,5.6v1.9H7.6c-2.1,0-3.8,1.7-3.8,3.8c0,2.1,1.7,3.8,3.8,3.8c17.2,0,31.5,0,48.8,0c2.1,0,3.8-1.7,3.8-3.8C60.1,9.2,58.4,7.5,56.4,7.5z M41.4,7.5H22.6V5.6c0-1,0.8-1.9,1.9-1.9h15c1,0,1.9,0.8,1.9,1.9V7.5z"/></svg></button>
                            </React.Fragment>
                        )
                    }
                </div>
